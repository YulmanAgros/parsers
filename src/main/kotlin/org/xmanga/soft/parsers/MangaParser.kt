...
import org.xmanga.soft.parsers.network.OkHttpWebClient
import org.xmanga.soft.parsers.network.WebClient
import org.xmanga.soft.parsers.util.FaviconParser
import org.xmanga.soft.parsers.util.RelatedMangaFinder
...
abstract class MangaParser @InternalParsersApi constructor(
	...
	@Deprecated(
		...
		ReplaceWith(
			...
			"org.xmanga.soft.parsers.model.MangaListFilter",
		),
	)
