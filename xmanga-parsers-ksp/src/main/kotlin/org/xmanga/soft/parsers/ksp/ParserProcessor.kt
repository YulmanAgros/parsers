package org.xmanga.soft.parsers.ksp
...
class ParserProcessor(
	...
	override fun process(resolver: Resolver): List<KSAnnotated> {
		val symbols =
			resolver
				.getSymbolsWithAnnotation("org.xmanga.soft.parsers.MangaSourceParser")
		...
		val factoryFile =
			try {
				codeGenerator.createNewFile(
					...
					packageName = "org.xmanga.soft.parsers",
		...
		val sourcesFile =
			try {
				codeGenerator.createNewFile(
					dependencies = dependencies,
					packageName = "org.xmanga.soft.parsers.model",
